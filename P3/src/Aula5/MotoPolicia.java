...
public class MotoPolicia extends Moto implements Policia, MotorizadoInterface{
	...
	public MotoPolicia(int ano, String cor, int nRodas, int VelMax, int cilindrada, String matricula, int ID, String tipo, int consumo, int potencia, String combustivel){
