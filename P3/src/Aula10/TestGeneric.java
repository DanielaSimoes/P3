...
public abstract class TestGeneric {
		...
		GenericIterator<Pessoa> vec = vp.iterator();
		...
		GenericIterator<Pessoa> lista = lp.iterator();
		...
		ListaGeneric<Pessoa> p = new ListaGeneric<Pessoa>();
		...
		public static double sumArea(ListaGeneric<? extends Figura> list){
			GenericIterator<? extends Figura> i = list.iterator();
			double sum = 0;
		...
		public static void printSet(GenericIterator lista){
